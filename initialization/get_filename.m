...
if wheel_type == 1
    if shape == 1
        filename = ['GrdData/' FOI '/' 'Bat' num2str(cycle) ...
    ...
    elseif shape == 2
        ...
        filename = ['GrdData/' FOI '/' 'Bat' num2str(cycle) 'xi' num2str(geoparam.xi) ...
            'Hsg' num2str(geoparam.sigmah) 'Rsg' num2str(geoparam.Rsigma)] ;
    end
elseif wheel_type == 2
    if sepparam.LS_mode == 1
        if shape == 1
            filename = ['GrdData/' FOI '/' 'Bat' num2str(cycle) 'LS' num2str(sepparam.LS_mode) ...
